...
{
	public class TagsFilteredByUserId : ProcessorState<Tag>
	{
		internal TagsFilteredByUserId(ExchangeUrl url, FilterUserIds ids)
		{
			this.Url = url;
			this.Url.QueryUrl = string.Format(UrlConstants.TagsByUserIdUrl, string.Join(";",ids.Value));
		}
