...
{
	public class OrderByDescending<T> : ProcessorState<T>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="OrderByDescending&lt;T&gt;"/> class.
		/// </summary>
		/// <param name="url">The URL.</param>
		/// <param name="orderby">The orderby.</param>
		internal OrderByDescending(ExchangeUrl url, FilterOrderBy orderby)
		{
