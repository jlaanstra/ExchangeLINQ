...
{
	public class UsersFilteredByIsModeratorElected : ProcessorState<User>
	{
		internal UsersFilteredByIsModeratorElected(ExchangeUrl url, FilterIsModerator mod, FilterIsElected el)
		{
			this.Url = url;
			this.Url.QueryUrl = UrlConstants.ElectedModeratorsUrl;
		}
